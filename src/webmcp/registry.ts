...
export const webmcpTools: WebMcpToolDefinition[] = [
  {
    ...
    inputSchema: {},
    outputSchema: statusOutputSchema.toJSON(),
    readOnly: true,
  ...
  },
  {
    ...
    inputSchema: locationSearchInputSchema.toJSON(),
    outputSchema: locationSearchOutputSchema.toJSON(),
    readOnly: true,
    requiresApproval: false,
    connectionStatus: 'CONNECTED',
  ...
  },
  {
    ...
    inputSchema: cubeInspectPositionInputSchema.toJSON(),
