...
const STATION_PROMPTS: Record<ResearchStationPreset['id'], string> = {
  arctic: `Create a premium 3D Arctic Cryosphere Watch research-station diorama that preserves the visual language and software functions of the source Arctic station while making the physical concept easier to understand. Show a stable ice-platform lab shell, weather/radiometry module, GNSS reference points, LiDAR/radar mast, communications hardware and a clearly separated under-ice sensor string representing CTD, ADCP and upward-looking sonar. Use frosted glass, brushed titanium, insulated white composite, cyan navigation light and realistic roughness/ice micro-normal detail. Keep instrument modules visually distinct and serviceable; no fantasy antennas or impossible floating equipment. The model is a research concept, not proof that hardware is deployed. Export clean UVs, PBR BaseColor/Normal/Roughness/Metallic/AO/Emissive, LODs, GLB/glTF, semantic-part names, bounds, pivot/orientation and provenance QA.`,
  sahara: `Create a premium 3D Sahara Water Memory research-station diorama that visually matches the existing Sahara station and represents its real software workflow: DEM terrain review, Priority-Flood/D8 drainage screening, palaeochannel hypotheses and field-verification planning. Include a compact shaded/domed laboratory, GNSS/weather mast, solar-radiometry array, terrain sample zone and a clearly readable dry-channel/flow-path overlay embedded in the base. Use sandstone composite, copper, dust-resistant glass and warm amber guide lighting with physically plausible PBR response. Do not depict discovered groundwater or restored rivers as facts. Export clean UVs, PBR maps, LODs, semantic parts, GLB/glTF and provenance QA.`,
  ocean: `Create a premium 3D Ocean Blue Sentinel research-station diorama that preserves the existing ocean station function set: bathymetry/trench investigation, coastal and surface-water context, survey-priority planning and field verification. Show a sea-surface reference plane, robust instrument buoy with GNSS/weather/comms, an AUV with multibeam sonar and CTD payload, and a cutaway seabed/bathymetry base with route markers. Use deep-glass ceramic, marine alloy, anti-fouling surfaces and restrained teal/blue emissive navigation lines. Clearly separate synthetic sandbox markers from measured observations. Export clean UVs, PBR maps, LODs, semantic parts, GLB/glTF and provenance QA.`,
  'earth-space': `Create a premium 3D Earth–Space Orbital Synthesis research interface/diorama, preserving the existing station functions without pretending it is a deployed orbital platform. Center a detailed Earth observation globe on an instrumented data plinth, surround it with restrained orbital context rings, a readable 8×8×8 analysis lattice for the 512-cell address system and a source-linked observation node representing JPL/SOHO evidence intake. Use obsidian glass, anodized dark alloy, violet/cyan data filaments and physically plausible emissive materials. Keep the 512 lattice legible and avoid turning it into decorative noise. Export clean UVs, PBR maps, LODs, semantic parts, GLB/glTF and provenance QA.`,
}
