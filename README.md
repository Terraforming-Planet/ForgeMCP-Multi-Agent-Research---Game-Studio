...
Open `/dashboard` and use the three one-click demo buttons. Vite uses a relative base and produces a static `dist/` suitable for GitHub Pages.
...
See [judge testing](docs/JUDGE_TESTING.md), [demo script](docs/DEMO_SCRIPT.md), [limitations](docs/LIMITATIONS.md), [security](docs/SECURITY.md), and [challenge changes](docs/CHALLENGE_WORK.md).
